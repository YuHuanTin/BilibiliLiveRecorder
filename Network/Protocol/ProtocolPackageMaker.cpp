...
#include "ProtocolPackageMaker.h"
...
std::expected<std::vector<uint8_t>, std::string>
ProtocolPackage::make(const std::string &DataToMake, OperatorType Operator) {
...
ProtocolPackage::parse(std::vector<uint8_t> &DataToParse) {
    /// make buffer
